...
# Instalar el Antigravity CLI oficial (para el coding pesado en free tier)
RUN wget -qO- https://antigravity.google/cli/install.sh | bash -s -- --dir /usr/local/bin
...
RUN mkdir -p /workspace /root/.gemini/antigravity-cli
